...
exports.default = {
    ...
    data: function data() {
        return {
            tabTitles: [{
                title: "首页",
                icon: "./home_default.png",
                activeIcon: "./home_selected.png"
            }, {
                title: "票据",
                icon: "./invoice_default.png",
                activeIcon: "./invoice_selected.png"
            }, {
                title: "单据",
                icon: "./receipt_default.png",
                activeIcon: "./receipt_selected.png"
            }, {
                title: "我的",
                icon: "./wo_default.png",
                activeIcon: "./wo_selected.png"
            }]
        };
    },
...
exports.default = {
  ...
  methods: {
    ...
    renderCellContent: function renderCellContent(createElement) {
      var resArr = [];
    ...
    renderCellType: function renderCellType(createElement) {
      return createElement("text", {
...
exports.default = {
  ...
  methods: {
    ...
    renderListTitle: function renderListTitle(createElement) {
      return createElement("text", {
        class: "aui-list-title"
      }, this.title);
    },
    renderListContent: function renderListContent(createElement) {
  ...
  render: function render(createElement) {
    ...
    }, [this.renderListTitle(createElement), this.renderListContent(createElement)]);
  }
};
...
exports.default = {
  ...
  props: {
    ...
    /**
     * 自定义类命传递
     * @values white/red/yellow/blue/green
     */
    type: {
      type: String,
      default: "white"
...
exports.default = {
  ...
  methods: {
    renderBtns: function renderBtns(createElement) {
      return this.list.map(function (btnItem) {
        var baseProps = {
          props: {}
        };
        btnItem.className !== void 0 && Object.assign(baseProps, {
          class: btnItem.className
        });
        btnItem.text !== void 0 && Object.assign(baseProps.props, {
          text: btnItem.text
        });
        btnItem.type !== void 0 && Object.assign(baseProps.props, {
          type: btnItem.type
        });
        btnItem.disabled !== void 0 && Object.assign(baseProps.props, {
